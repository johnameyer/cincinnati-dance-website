<div id="link-cards" class="row">
	<div class="col">
		<a class="btn btn-primary w-100" style="margin:5px" href="about/why.php">
	...
	<div class="col">
		<a class="btn btn-primary w-100" style="margin:5px" href="about/crew.php">
	...
	<div class="col">
		<a class="btn btn-primary w-100" style="margin:5px" href="about/studio.php">
