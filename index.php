...
<body>
	...
	<div class="container">
		<div class="section">
			<br>
			<br>
			<h1 class="header center teal-text text-lighten-2">The Cincinnati Dance and Movement Center</h1>
			<div class="row center">
				<h5 class="header col s12 light">Welcome to the web site of the Cincinnati Dance and Movement Center, serving Springfield Township, Wyoming, Finneytown, Mt. Healthy, Greenhills, Forest Park, and the Greater Cincinnati area.</h5>
			</div>
			<div class="row center">
			...
			<div class="row">
				<div class="col s12 center">
					...
					<p class="left-align light">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque id nunc nec volutpat. Etiam pellentesque
						...
						sollicitudin diam, eu mattis nisl maximus sed. Nulla imperdiet semper molestie. Morbi massa odio, condimentum sed ipsum
						ac, gravida ultrices erat. Nullam eget dignissim mauris, non tristique erat. Vestibulum ante ipsum primis in faucibus
		...
		<ul class="slides">
			<li>
				<div class="caption left-align">
					<h3>This is a quote from a happy customer</h3>
				</div>
			</li>
			<li>
				<div class="caption left-align">
					<h3>Another random quote</h3>
				</div>
			</li>
			<li>
				<div class="caption left-align">
